...
public class StatBase {
	...
	private final net.minecraft.achievement.stats.IStatType field_25065_a;
	private static NumberFormat field_25066_b = NumberFormat.getIntegerInstance(Locale.US);
	public static net.minecraft.achievement.stats.IStatType field_27056_i = new StatTypeSimple();
	private static DecimalFormat field_25068_c = new DecimalFormat("########0.00");
	public static net.minecraft.achievement.stats.IStatType field_27055_j = new StatTypeTime();
	public static net.minecraft.achievement.stats.IStatType field_27054_k = new StatTypeDistance();
