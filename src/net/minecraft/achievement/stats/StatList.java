		...
		if(field_25101_D && field_25099_E) {
			...
			while(var1.hasNext()) {
				...
				if(Item.itemsList[var5.intValue()] != null) {
					String var3 = StatCollector.translateToLocalFormatted("stat.craftItem", new Object[]{Item.itemsList[var5.intValue()].getNameLocalizedForStats()});
	...
	private static StatBase[] func_25090_a(StatBase[] var0, String var1, int var2, int var3, int var4) {
		...
		for(int var5 = var3; var5 < var4; ++var5) {
			if(Item.itemsList[var5] != null) {
				String var6 = StatCollector.translateToLocalFormatted(var1, new Object[]{Item.itemsList[var5].getNameLocalizedForStats()});
