...
public class PlayerNBTManager implements IPlayerFileData, ISaveHandler {
		...
		try {
			...
			try {
				if(var2.readLong() != this.field_22100_d) {
					throw new net.minecraft.core.MinecraftException("The save is being accessed from another location, aborting");
				}
			} finally {
				var2.close();
			}
	...
	public IChunkLoader func_22092_a(WorldProvider var1) {
		if(var1 instanceof WorldProviderHell) {
			...
			var2.mkdirs();
			return new net.minecraft.world.chunk.ChunkLoader(var2, true);
		} else {
			return new ChunkLoader(this.worldDir, true);
		}
	}

	public net.minecraft.world.WorldInfo func_22096_c() {
		...
		if(var1.exists()) {
			try {
				var2 = net.minecraft.core.CompressedStreamTools.func_770_a(new FileInputStream(var1));
	...
	public void func_22095_a(net.minecraft.world.WorldInfo var1, List var2) {
		net.minecraft.util.nbt.NBTTagCompound var3 = var1.func_22183_a(var2);
		...
		try {
			...
			net.minecraft.core.CompressedStreamTools.writeGzippedCompoundToOutputStream(var4, new FileOutputStream(var5));
			if(var6.exists()) {
				var6.delete();
			}
	...
	public void func_22094_a(WorldInfo var1) {
		net.minecraft.util.nbt.NBTTagCompound var2 = var1.func_22185_a();
		...
		try {
			...
			net.minecraft.core.CompressedStreamTools.writeGzippedCompoundToOutputStream(var3, new FileOutputStream(var4));
			if(var5.exists()) {
				var5.delete();
			}
	...
	public void writePlayerData(net.minecraft.entity.living.EntityPlayer var1) {
		try {
			net.minecraft.util.nbt.NBTTagCompound var2 = new net.minecraft.util.nbt.NBTTagCompound();
			var1.writeToNBT(var2);
			File var3 = new File(this.worldFile, "_tmp_.dat");
			File var4 = new File(this.worldFile, var1.username + ".dat");
			net.minecraft.core.CompressedStreamTools.writeGzippedCompoundToOutputStream(var2, new FileOutputStream(var3));
			if(var4.exists()) {
				var4.delete();
			}
	...
	public void readPlayerData(EntityPlayer var1) {
		net.minecraft.util.nbt.NBTTagCompound var2 = this.getPlayerData(var1.username);
		if(var2 != null) {
