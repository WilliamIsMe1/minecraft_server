...
public class WorldServer extends World {
	public net.minecraft.world.chunk.ChunkProviderServer chunkProviderServer;
	...
	public void updateEntityWithOptionalForce(net.minecraft.entity.Entity var1, boolean var2) {
		...
		if(var1.riddenByEntity == null || !(var1.riddenByEntity instanceof net.minecraft.entity.living.EntityPlayer)) {
			super.updateEntityWithOptionalForce(var1, var2);
		}

	}

	public void func_12017_b(net.minecraft.entity.Entity var1, boolean var2) {
		super.updateEntityWithOptionalForce(var1, var2);
	}
	...
	public List getTileEntityList(int var1, int var2, int var3, int var4, int var5, int var6) {
		...
		for(int var8 = 0; var8 < this.loadedTileEntityList.size(); ++var8) {
			net.minecraft.block.tileentity.TileEntity var9 = (TileEntity)this.loadedTileEntityList.get(var8);
	...
	public boolean canMineBlock(EntityPlayer var1, int var2, int var3, int var4) {
		int var5 = (int) net.minecraft.util.MathHelper.abs((float)(var2 - this.worldInfo.getSpawnX()));
	...
	public net.minecraft.entity.Entity func_6158_a(int var1) {
		return (net.minecraft.entity.Entity)this.field_20912_E.lookup(var1);
	}
	...
	public void sendTrackedEntityStatusUpdatePacket(net.minecraft.entity.Entity var1, byte var2) {
		net.minecraft.network.packet.Packet38EntityStatus var3 = new Packet38EntityStatus(var1.entityId, var2);
	...
	protected void updateWeather() {
		...
		if(var1 != this.func_27068_v()) {
			if(var1) {
				this.mcServer.configManager.sendPacketToAllPlayers(new net.minecraft.network.packet.Packet70Bed(2));
			} else {
