...
public class Chunk {
	...
	private void func_355_f(int var1, int var2, int var3) {
		...
		if(var4 > var3) {
			this.worldObj.scheduleLightingUpdate(net.minecraft.block.EnumSkyBlock.Sky, var1, var3, var2, var1, var4, var2);
			this.isModified = true;
		} else if(var4 < var3) {
			this.worldObj.scheduleLightingUpdate(net.minecraft.block.EnumSkyBlock.Sky, var1, var4, var2, var1, var3, var2);
			this.isModified = true;
		}
	...
	private void func_339_g(int var1, int var2, int var3) {
		...
		if(var5 != var4) {
			...
			if(var5 < var4) {
				...
				this.worldObj.scheduleLightingUpdate(net.minecraft.block.EnumSkyBlock.Sky, var7, var4, var8, var7, var5, var8);
			...
			if(var5 != var10) {
				this.worldObj.scheduleLightingUpdate(net.minecraft.block.EnumSkyBlock.Sky, var7 - 1, var5, var8 - 1, var7 + 1, var10, var8 + 1);
			}
	...
	public boolean setBlockIDWithMetadata(int var1, int var2, int var3, int var4, int var5) {
		...
		if(var8 == var4 && this.data.getNibble(var1, var2, var3) == var5) {
			...
			if(!this.worldObj.worldProvider.field_4306_c) {
				...
				this.worldObj.scheduleLightingUpdate(net.minecraft.block.EnumSkyBlock.Sky, var9, var2, var10, var9, var2, var10);
			}

			this.worldObj.scheduleLightingUpdate(net.minecraft.block.EnumSkyBlock.Block, var9, var2, var10, var9, var2, var10);
	...
	public int getSavedLightValue(net.minecraft.block.EnumSkyBlock var1, int var2, int var3, int var4) {
		return var1 == net.minecraft.block.EnumSkyBlock.Sky ? this.skylightMap.getNibble(var2, var3, var4) : (var1 == net.minecraft.block.EnumSkyBlock.Block ? this.blocklightMap.getNibble(var2, var3, var4) : 0);
	}
	...
	public net.minecraft.block.tileentity.TileEntity getChunkBlockTileEntity(int var1, int var2, int var3) {
		ChunkPosition var4 = new ChunkPosition(var1, var2, var3);
		net.minecraft.block.tileentity.TileEntity var5 = (net.minecraft.block.tileentity.TileEntity)this.chunkTileEntityMap.get(var4);
		if(var5 == null) {
			...
			var5 = (net.minecraft.block.tileentity.TileEntity)this.chunkTileEntityMap.get(var4);
		}
	...
	public void addTileEntity(net.minecraft.block.tileentity.TileEntity var1) {
	...
	public void setChunkBlockTileEntity(int var1, int var2, int var3, net.minecraft.block.tileentity.TileEntity var4) {
	...
	public void removeChunkBlockTileEntity(int var1, int var2, int var3) {
		ChunkPosition var4 = new ChunkPosition(var1, var2, var3);
		if(this.isChunkLoaded) {
			net.minecraft.block.tileentity.TileEntity var5 = (net.minecraft.block.tileentity.TileEntity)this.chunkTileEntityMap.remove(var4);
			if(var5 != null) {
				var5.invalidate();
			}
		}
	...
	public void onChunkUnload() {
		...
		while(var1.hasNext()) {
			net.minecraft.block.tileentity.TileEntity var2 = (TileEntity)var1.next();
			var2.invalidate();
		}
