...
public class WorldGenDungeons extends WorldGenerator {
	public boolean generate(World var1, Random var2, int var3, int var4, int var5) {
		...
		if(var9 >= 1 && var9 <= 5) {
				...
				for(var11 = 0; var11 < 3; ++var11) {
					...
					if(var1.isAirBlock(var12, var4, var14)) {
						...
						if(var15 == 1) {
							...
							net.minecraft.block.tileentity.TileEntityChest var16 = (TileEntityChest)var1.getBlockTileEntity(var12, var4, var14);
							int var17 = 0;
			...
			net.minecraft.block.tileentity.TileEntityMobSpawner var19 = (TileEntityMobSpawner)var1.getBlockTileEntity(var3, var4, var5);
	...
	private ItemStack pickCheckLootItem(Random var1) {
		...
		return var2 == 0 ? new ItemStack(net.minecraft.item.core.Item.saddle) : (var2 == 1 ? new ItemStack(net.minecraft.item.core.Item.ingotIron, var1.nextInt(4) + 1) : (var2 == 2 ? new ItemStack(net.minecraft.item.core.Item.bread) : (var2 == 3 ? new ItemStack(net.minecraft.item.core.Item.wheat, var1.nextInt(4) + 1) : (var2 == 4 ? new ItemStack(net.minecraft.item.core.Item.gunpowder, var1.nextInt(4) + 1) : (var2 == 5 ? new ItemStack(net.minecraft.item.core.Item.silk, var1.nextInt(4) + 1) : (var2 == 6 ? new ItemStack(net.minecraft.item.core.Item.bucketEmpty) : (var2 == 7 && var1.nextInt(100) == 0 ? new ItemStack(net.minecraft.item.core.Item.appleGold) : (var2 == 8 && var1.nextInt(2) == 0 ? new ItemStack(net.minecraft.item.core.Item.redstone, var1.nextInt(4) + 1) : (var2 == 9 && var1.nextInt(10) == 0 ? new ItemStack(net.minecraft.item.core.Item.itemsList[net.minecraft.item.core.Item.record13.shiftedIndex + var1.nextInt(2)]) : (var2 == 10 ? new ItemStack(Item.dyePowder, 1, 3) : null))))))))));
	}
