...
public class TileEntityFurnace extends TileEntity implements IInventory {
	...
	private boolean canSmelt() {
		if(this.furnaceItemStacks[0] == null) {
			...
			ItemStack var1 = net.minecraft.item.recipe.FurnaceRecipes.smelting().getSmeltingResult(this.furnaceItemStacks[0].getItem().shiftedIndex);
	...
	private int getItemBurnTime(ItemStack var1) {
		if(var1 == null) {
			...
			return var2 < 256 && Block.blocksList[var2].blockMaterial == Material.wood ? 300 : (var2 == net.minecraft.item.core.Item.stick.shiftedIndex ? 100 : (var2 == net.minecraft.item.core.Item.coal.shiftedIndex ? 1600 : (var2 == Item.bucketLava.shiftedIndex ? 20000 : (var2 == Block.sapling.blockID ? 100 : 0))));
		}
	}
