...
public abstract class BlockFluid extends Block {
	protected BlockFluid(int var1, net.minecraft.block.material.Material var2) {
		super(var1, (var2 == net.minecraft.block.material.Material.lava ? 14 : 12) * 16 + 13, var2);
		float var3 = 0.0F;
		float var4 = 0.0F;
	...
	protected int func_301_g(net.minecraft.world.World var1, int var2, int var3, int var4) {
		return var1.getBlockMaterial(var2, var3, var4) != this.blockMaterial ? -1 : var1.getBlockMetadata(var2, var3, var4);
	}

	protected int func_303_b(net.minecraft.block.core.IBlockAccess var1, int var2, int var3, int var4) {
	...
	public boolean shouldSideBeRendered(net.minecraft.block.core.IBlockAccess var1, int var2, int var3, int var4, int var5) {
		net.minecraft.block.material.Material var6 = var1.getBlockMaterial(var2, var3, var4);
		return var6 == this.blockMaterial ? false : (var6 == net.minecraft.block.material.Material.ice ? false : (var5 == 1 ? true : super.shouldSideBeRendered(var1, var2, var3, var4, var5)));
	}
	...
	private net.minecraft.core.Vec3D func_298_c(IBlockAccess var1, int var2, int var3, int var4) {
	...
	public int tickRate() {
		return this.blockMaterial == net.minecraft.block.material.Material.water ? 5 : (this.blockMaterial == net.minecraft.block.material.Material.lava ? 30 : 0);
	}
	...
	private void checkForHarden(net.minecraft.world.World var1, int var2, int var3, int var4) {
		if(var1.getBlockId(var2, var3, var4) == this.blockID) {
			if(this.blockMaterial == net.minecraft.block.material.Material.lava) {
				boolean var5 = false;
				if(var5 || var1.getBlockMaterial(var2, var3, var4 - 1) == net.minecraft.block.material.Material.water) {
					var5 = true;
				}
				...
				if(var5 || var1.getBlockMaterial(var2 - 1, var3, var4) == net.minecraft.block.material.Material.water) {
					var5 = true;
				}
