...
public abstract class BlockFluid extends Block {
	...
	protected int getEffectiveFlowDecay(net.minecraft.block.core.IBlockAccess var1, int var2, int var3, int var4) {
	...
	public boolean getIsBlockSolid(IBlockAccess var1, int var2, int var3, int var4, int var5) {
		...
		return var6 != this.blockMaterial && (var6 != Material.ice && (var5 == 1 || super.getIsBlockSolid(var1, var2, var3, var4, var5)));
	}
	...
	public boolean shouldSideBeRendered(net.minecraft.block.core.IBlockAccess var1, int var2, int var3, int var4, int var5) {
		...
		return var6 != this.blockMaterial && (var6 != Material.ice && (var5 == 1 || super.shouldSideBeRendered(var1, var2, var3, var4, var5)));
	}
