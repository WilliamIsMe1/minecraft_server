...
public class BlockFlowing extends BlockFluid {
	...
	public void updateTick(World var1, int var2, int var3, int var4, Random var5) {
		...
		if(var6 > 0) {
			...
			if(this.blockMaterial == Material.lava && var10 < 8 && var10 > var6 && var5.nextInt(4) != 0) {
				var10 = var6;
				var8 = false;
			}
	...
	private boolean canLiquidDisplaceBlock(World var1, int var2, int var3, int var4) {
		...
		return var5 != this.blockMaterial && (var5 != Material.lava && !this.blockBlocksFlow(var1, var2, var3, var4));
	}
