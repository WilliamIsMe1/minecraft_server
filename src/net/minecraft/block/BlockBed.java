...
public class BlockBed extends net.minecraft.block.core.Block {
		...
		if(!var1.multiplayerWorld) {
			...
			if(!var1.worldProvider.func_28108_d()) {
				...
				if(func_22018_f(var6)) {
					net.minecraft.entity.living.EntityPlayer var14 = null;
					Iterator var8 = var1.playerEntities.iterator();

					while(var8.hasNext()) {
						net.minecraft.entity.living.EntityPlayer var9 = (EntityPlayer)var8.next();
						if(var9.func_22057_E()) {
							net.minecraft.world.chunk.ChunkCoordinates var10 = var9.playerLocation;
	...
	public static void func_22022_a(net.minecraft.world.World var0, int var1, int var2, int var3, boolean var4) {
	...
	public static net.minecraft.world.chunk.ChunkCoordinates func_22021_g(net.minecraft.world.World var0, int var1, int var2, int var3, int var4) {
		int var5 = var0.getBlockMetadata(var1, var2, var3);
