...
public class BlockRail extends net.minecraft.block.core.Block {
	...
	public int getBlockTextureFromSideAndMetadata(int var1, int var2) {
		if(this.field_27034_a) {
			if(this.blockID == net.minecraft.block.core.Block.railPowered.blockID && (var2 & 8) == 0) {
	...
	public void onNeighborBlockChange(net.minecraft.world.World var1, int var2, int var3, int var4, int var5) {
		if(var1.multiplayerWorld) {
			...
			} else if(this.blockID == net.minecraft.block.core.Block.railPowered.blockID) {
			...
			} else if(var5 > 0 && net.minecraft.block.core.Block.blocksList[var5].canProvidePower() && !this.field_27034_a && RailLogic.getNAdjacentTracks(new RailLogic(this, var1, var2, var3, var4)) == 3) {
	...
	private boolean func_27032_a(net.minecraft.world.World var1, int var2, int var3, int var4, int var5, boolean var6, int var7) {
		if(var7 >= 8) {
			return false;
		} else {
			int var8 = var5 & 7;
