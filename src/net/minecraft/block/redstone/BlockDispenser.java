...
public class BlockDispenser extends BlockContainer {
	...
	public int idDropped(int var1, Random var2) {
		return net.minecraft.block.core.Block.dispenser.blockID;
	}
	...
	private void dispenseItem(net.minecraft.world.World var1, int var2, int var3, int var4, Random var5) {
		...
		net.minecraft.block.tileentity.TileEntityDispenser var11 = (net.minecraft.block.tileentity.TileEntityDispenser)var1.getBlockTileEntity(var2, var3, var4);
		...
		if(var12 == null) {
			...
			if(var12.itemID == net.minecraft.item.core.Item.arrow.shiftedIndex) {
			...
			} else if(var12.itemID == net.minecraft.item.core.Item.egg.shiftedIndex) {
	...
	protected net.minecraft.block.tileentity.TileEntity getBlockEntity() {
		return new net.minecraft.block.tileentity.TileEntityDispenser();
	}
	...
	public void onBlockRemoval(World var1, int var2, int var3, int var4) {
		net.minecraft.block.tileentity.TileEntityDispenser var5 = (TileEntityDispenser)var1.getBlockTileEntity(var2, var3, var4);
