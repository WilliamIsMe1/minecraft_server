...
public class BlockPistonBase extends net.minecraft.block.core.Block {
	...
	private void updatePistonState(net.minecraft.world.World var1, int var2, int var3, int var4) {
	...
	private boolean isPowered(net.minecraft.world.World var1, int var2, int var3, int var4, int var5) {
	...
	public void playBlock(net.minecraft.world.World var1, int var2, int var3, int var4, int var5, int var6) {
		...
		if(var5 == 0) {
			...
			net.minecraft.block.tileentity.TileEntity var8 = var1.getBlockTileEntity(var2 + PistonBlockTextures.field_31051_b[var6], var3 + PistonBlockTextures.field_31054_c[var6], var4 + PistonBlockTextures.field_31053_d[var6]);
			if(var8 != null && var8 instanceof net.minecraft.block.tileentity.TileEntityPiston) {
				((net.minecraft.block.tileentity.TileEntityPiston)var8).clearPistonTileEntity();
			}

			var1.setBlockAndMetadata(var2, var3, var4, net.minecraft.block.core.Block.pistonMoving.blockID, var6);
			...
			if(this.isSticky) {
				...
				boolean var14 = false;
				if(var12 == net.minecraft.block.core.Block.pistonMoving.blockID) {
					net.minecraft.block.tileentity.TileEntity var15 = var1.getBlockTileEntity(var9, var10, var11);
					if(var15 != null && var15 instanceof net.minecraft.block.tileentity.TileEntityPiston) {
						net.minecraft.block.tileentity.TileEntityPiston var16 = (TileEntityPiston)var15;
				...
				if(var14 || var12 <= 0 || !canPushBlock(var12, var1, var9, var10, var11, false) || net.minecraft.block.core.Block.blocksList[var12].getMobilityFlag() != 0 && var12 != net.minecraft.block.core.Block.pistonBase.blockID && var12 != net.minecraft.block.core.Block.pistonStickyBase.blockID) {
					if(!var14) {
					...
					var1.setBlockAndMetadata(var2, var3, var4, net.minecraft.block.core.Block.pistonMoving.blockID, var13);
	...
	private static int determineOrientation(net.minecraft.world.World var0, int var1, int var2, int var3, EntityPlayer var4) {
		if(net.minecraft.util.MathHelper.abs((float)var4.posX - (float)var1) < 2.0F && net.minecraft.util.MathHelper.abs((float)var4.posZ - (float)var3) < 2.0F) {
	...
	private static boolean canPushBlock(int var0, net.minecraft.world.World var1, int var2, int var3, int var4, boolean var5) {
		if(var0 == net.minecraft.block.core.Block.obsidian.blockID) {
			return false;
		} else {
			if(var0 != net.minecraft.block.core.Block.pistonBase.blockID && var0 != net.minecraft.block.core.Block.pistonStickyBase.blockID) {
				if(net.minecraft.block.core.Block.blocksList[var0].getHardness() == -1.0F) {
					return false;
				}

				if(net.minecraft.block.core.Block.blocksList[var0].getMobilityFlag() == 2) {
					return false;
				}

				if(!var5 && net.minecraft.block.core.Block.blocksList[var0].getMobilityFlag() == 1) {
					return false;
				}
	...
	private static boolean canExtend(net.minecraft.world.World var0, int var1, int var2, int var3, int var4) {
		...
		while(true) {
			if(var8 < 13) {
				...
				if(var9 != 0) {
					...
					if(net.minecraft.block.core.Block.blocksList[var9].getMobilityFlag() != 1) {
						if(var8 == 12) {
							return false;
						}
		...
		while(true) {
			...
			if(var9 < 13) {
				...
				if(var10 != 0) {
					...
					if(net.minecraft.block.core.Block.blocksList[var10].getMobilityFlag() != 1) {
						if(var9 == 12) {
							return false;
						}
					...
					net.minecraft.block.core.Block.blocksList[var10].dropBlockAsItem(var1, var6, var7, var8, var1.getBlockMetadata(var6, var7, var8));
			...
			while(var6 != var2 || var7 != var3 || var8 != var4) {
				...
				if(var12 == this.blockID && var9 == var2 && var10 == var3 && var11 == var4) {
					var1.setBlockAndMetadata(var6, var7, var8, net.minecraft.block.core.Block.pistonMoving.blockID, var5 | (this.isSticky ? 8 : 0));
					var1.setBlockTileEntity(var6, var7, var8, BlockPistonMoving.getTileEntity(net.minecraft.block.core.Block.pistonExtension.blockID, var5 | (this.isSticky ? 8 : 0), var5, true, false));
				} else {
