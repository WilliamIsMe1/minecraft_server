...
public class BlockDoor extends net.minecraft.block.core.Block {
	...
	public boolean blockActivated(net.minecraft.world.World var1, int var2, int var3, int var4, net.minecraft.entity.living.EntityPlayer var5) {
		if(this.blockMaterial == net.minecraft.block.material.Material.iron) {
			return true;
		} else {
	...
	public void func_272_a(net.minecraft.world.World var1, int var2, int var3, int var4, boolean var5) {
		int var6 = var1.getBlockMetadata(var2, var3, var4);
		if((var6 & 8) != 0) {
			if(var1.getBlockId(var2, var3 - 1, var4) == this.blockID) {
	...
	public void onNeighborBlockChange(net.minecraft.world.World var1, int var2, int var3, int var4, int var5) {
		...
		if((var6 & 8) != 0) {
			...
			if(var5 > 0 && net.minecraft.block.core.Block.blocksList[var5].canProvidePower()) {
