...
public class BlockRedstoneRepeater extends net.minecraft.block.core.Block {
	...
	public void updateTick(net.minecraft.world.World var1, int var2, int var3, int var4, Random var5) {
		...
		if(this.field_22015_c && !var7) {
			var1.setBlockAndMetadataWithNotify(var2, var3, var4, net.minecraft.block.core.Block.redstoneRepeaterIdle.blockID, var6);
		} else if(!this.field_22015_c) {
			var1.setBlockAndMetadataWithNotify(var2, var3, var4, net.minecraft.block.core.Block.redstoneRepeaterActive.blockID, var6);
			if(!var7) {
				int var8 = (var6 & 12) >> 2;
				var1.scheduleUpdateTick(var2, var3, var4, net.minecraft.block.core.Block.redstoneRepeaterActive.blockID, field_22013_b[var8] * 2);
			}
		}
	...
	private boolean func_22012_g(net.minecraft.world.World var1, int var2, int var3, int var4, int var5) {
		int var6 = var5 & 3;
		switch(var6) {
		case 0:
			return var1.isBlockIndirectlyProvidingPowerTo(var2, var3, var4 + 1, 3) || var1.getBlockId(var2, var3, var4 + 1) == net.minecraft.block.core.Block.redstoneWire.blockID && var1.getBlockMetadata(var2, var3, var4 + 1) > 0;
		case 1:
			return var1.isBlockIndirectlyProvidingPowerTo(var2 - 1, var3, var4, 4) || var1.getBlockId(var2 - 1, var3, var4) == net.minecraft.block.core.Block.redstoneWire.blockID && var1.getBlockMetadata(var2 - 1, var3, var4) > 0;
		case 2:
			return var1.isBlockIndirectlyProvidingPowerTo(var2, var3, var4 - 1, 2) || var1.getBlockId(var2, var3, var4 - 1) == net.minecraft.block.core.Block.redstoneWire.blockID && var1.getBlockMetadata(var2, var3, var4 - 1) > 0;
		case 3:
