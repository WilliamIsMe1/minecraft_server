...
public class BlockPistonExtension extends net.minecraft.block.core.Block {
	...
	public void onBlockRemoval(net.minecraft.world.World var1, int var2, int var3, int var4) {
		...
		if(var7 == net.minecraft.block.core.Block.pistonBase.blockID || var7 == net.minecraft.block.core.Block.pistonStickyBase.blockID) {
			var5 = var1.getBlockMetadata(var2, var3, var4);
			if(BlockPistonBase.isExtended(var5)) {
				net.minecraft.block.core.Block.blocksList[var7].dropBlockAsItem(var1, var2, var3, var4, var5);
