...
public class BlockRedstoneOre extends net.minecraft.block.core.Block {
	...
	private void func_321_g(net.minecraft.world.World var1, int var2, int var3, int var4) {
		this.func_320_h(var1, var2, var3, var4);
		if(this.blockID == net.minecraft.block.core.Block.oreRedstone.blockID) {
			var1.setBlockWithNotify(var2, var3, var4, net.minecraft.block.core.Block.oreRedstoneGlowing.blockID);
		}

	}

	public void updateTick(net.minecraft.world.World var1, int var2, int var3, int var4, Random var5) {
		if(this.blockID == net.minecraft.block.core.Block.oreRedstoneGlowing.blockID) {
