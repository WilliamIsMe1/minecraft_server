...
class PlayerInstance {
	...
	private int chunkX;
	private int chunkZ;
	private net.minecraft.world.chunk.ChunkCoordIntPair currentChunk;
	...
	public void addPlayer(EntityPlayerMP var1) {
		if(this.players.contains(var1)) {
			...
			var1.playerNetServerHandler.sendPacket(new net.minecraft.network.packet.Packet50PreChunk(this.currentChunk.chunkXPos, this.currentChunk.chunkZPos, true));
	...
	public void sendPacketToPlayersInInstance(net.minecraft.network.packet.Packet var1) {
			...
			if(this.numBlocksToUpdate == 1) {
				...
				if(this.numBlocksToUpdate == 10) {
					...
					for(int var9 = 0; var9 < var8.size(); ++var9) {
						this.updateTileEntity((net.minecraft.block.tileentity.TileEntity)var8.get(var9));
					}
				} else {
