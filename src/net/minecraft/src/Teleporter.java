...
public class Teleporter {
	...
	public void setExitLocation(net.minecraft.world.World var1, net.minecraft.entity.Entity var2) {
	...
	public boolean findExitLocation(net.minecraft.world.World var1, net.minecraft.entity.Entity var2) {
		short var3 = 128;
		double var4 = -1.0D;
		int var6 = 0;
		int var7 = 0;
		int var8 = 0;
		int var9 = net.minecraft.util.MathHelper.floor_double(var2.posX);
		int var10 = net.minecraft.util.MathHelper.floor_double(var2.posZ);
	...
	public boolean createExitLocation(World var1, Entity var2) {
		byte var3 = 16;
		double var4 = -1.0D;
		int var6 = net.minecraft.util.MathHelper.floor_double(var2.posX);
		int var7 = net.minecraft.util.MathHelper.floor_double(var2.posY);
