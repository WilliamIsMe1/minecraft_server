...
public class AxisAlignedBB {
	...
	public boolean isVecInXYZ(net.minecraft.core.Vec3D var1) {
	...
	public MovingObjectPosition func_706_a(net.minecraft.core.Vec3D var1, net.minecraft.core.Vec3D var2) {
