...
public class ThreadLoginVerifier extends Thread {
	final net.minecraft.network.packet.Packet1Login loginPacket;
	final net.minecraft.network.NetLoginHandler loginHandler;

	ThreadLoginVerifier(net.minecraft.network.NetLoginHandler var1, Packet1Login var2) {
	...
	public void run() {
		try {
			String var1 = net.minecraft.network.NetLoginHandler.getServerId(this.loginHandler);
