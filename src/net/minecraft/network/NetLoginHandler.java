...
public class NetLoginHandler extends NetHandler {
	...
	private net.minecraft.network.packet.Packet1Login packet1login = null;
	...
	public void handleHandshake(net.minecraft.network.packet.Packet2Handshake var1) {
		if(this.mcServer.onlineMode) {
			this.serverId = Long.toHexString(rand.nextLong());
			this.netManager.addToSendQueue(new net.minecraft.network.packet.Packet2Handshake(this.serverId));
		} else {
	...
	public void handleLogin(net.minecraft.network.packet.Packet1Login var1) {
	...
	public void doLogin(net.minecraft.network.packet.Packet1Login var1) {
		...
		if(var2 != null) {
			...
			var5.sendPacket(new net.minecraft.network.packet.Packet1Login("", var2.entityId, var3.getRandomSeed(), (byte)var3.worldProvider.worldType));
	...
	static net.minecraft.network.packet.Packet1Login setLoginPacket(NetLoginHandler var0, Packet1Login var1) {
