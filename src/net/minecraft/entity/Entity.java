...
public abstract class Entity {
	...
	public void onEntityUpdate() {
		...
		if(this.handleWaterMovement()) {
			if(!this.inWater && !this.firstUpdate) {
				float var1 = net.minecraft.util.MathHelper.sqrt_double(this.motionX * this.motionX * (double)0.2F + this.motionY * this.motionY + this.motionZ * this.motionZ * (double)0.2F) * 0.2F;
				if(var1 > 1.0F) {
					var1 = 1.0F;
				}

				this.worldObj.playSoundAtEntity(this, "random.splash", var1, 1.0F + (this.rand.nextFloat() - this.rand.nextFloat()) * 0.4F);
				float var2 = (float) net.minecraft.util.MathHelper.floor_double(this.boundingBox.minY);
	...
	public void moveEntity(double var1, double var3, double var5) {
		if(this.noClip) {
			...
			if(this.func_25017_l() && !var18 && this.ridingEntity == null) {
				this.distanceWalkedModified = (float)((double)this.distanceWalkedModified + (double) net.minecraft.util.MathHelper.sqrt_double(var37 * var37 + var23 * var23) * 0.6D);
				var38 = net.minecraft.util.MathHelper.floor_double(this.posX);
				var26 = net.minecraft.util.MathHelper.floor_double(this.posY - (double)0.2F - (double)this.yOffset);
				var39 = net.minecraft.util.MathHelper.floor_double(this.posZ);
			...
			var38 = net.minecraft.util.MathHelper.floor_double(this.boundingBox.minX + 0.001D);
			var26 = net.minecraft.util.MathHelper.floor_double(this.boundingBox.minY + 0.001D);
			var39 = net.minecraft.util.MathHelper.floor_double(this.boundingBox.minZ + 0.001D);
			var28 = net.minecraft.util.MathHelper.floor_double(this.boundingBox.maxX - 0.001D);
			int var40 = net.minecraft.util.MathHelper.floor_double(this.boundingBox.maxY - 0.001D);
			int var30 = net.minecraft.util.MathHelper.floor_double(this.boundingBox.maxZ - 0.001D);
	...
	public boolean func_27008_Y() {
		return this.inWater || this.worldObj.canLightningStrikeAt(net.minecraft.util.MathHelper.floor_double(this.posX), net.minecraft.util.MathHelper.floor_double(this.posY), net.minecraft.util.MathHelper.floor_double(this.posZ));
	}
	...
	public boolean handleWaterMovement() {
		return this.worldObj.handleMaterialAcceleration(this.boundingBox.expand(0.0D, (double)-0.4F, 0.0D).getInsetBoundingBox(0.001D, 0.001D, 0.001D), net.minecraft.block.material.Material.water, this);
	}

	public boolean isInsideOfMaterial(net.minecraft.block.material.Material var1) {
		double var2 = this.posY + (double)this.getEyeHeight();
		int var4 = net.minecraft.util.MathHelper.floor_double(this.posX);
		int var5 = net.minecraft.util.MathHelper.floor_float((float) net.minecraft.util.MathHelper.floor_double(var2));
		int var6 = net.minecraft.util.MathHelper.floor_double(this.posZ);
	...
	public void moveFlying(float var1, float var2, float var3) {
		float var4 = net.minecraft.util.MathHelper.sqrt_float(var1 * var1 + var2 * var2);
		if(var4 >= 0.01F) {
			if(var4 < 1.0F) {
				var4 = 1.0F;
			}
			...
			var1 *= var4;
			var2 *= var4;
			float var5 = net.minecraft.util.MathHelper.sin(this.rotationYaw * (float)Math.PI / 180.0F);
			float var6 = net.minecraft.util.MathHelper.cos(this.rotationYaw * (float)Math.PI / 180.0F);
	...
	public float getEntityBrightness(float var1) {
		int var2 = net.minecraft.util.MathHelper.floor_double(this.posX);
		double var3 = (this.boundingBox.maxY - this.boundingBox.minY) * 0.66D;
		int var5 = net.minecraft.util.MathHelper.floor_double(this.posY - (double)this.yOffset + var3);
		int var6 = net.minecraft.util.MathHelper.floor_double(this.posZ);
		if(this.worldObj.checkChunksExist(net.minecraft.util.MathHelper.floor_double(this.boundingBox.minX), net.minecraft.util.MathHelper.floor_double(this.boundingBox.minY), net.minecraft.util.MathHelper.floor_double(this.boundingBox.minZ), net.minecraft.util.MathHelper.floor_double(this.boundingBox.maxX), net.minecraft.util.MathHelper.floor_double(this.boundingBox.maxY), net.minecraft.util.MathHelper.floor_double(this.boundingBox.maxZ))) {
	...
	public float getDistanceToEntity(Entity var1) {
		...
		return net.minecraft.util.MathHelper.sqrt_float(var2 * var2 + var3 * var3 + var4 * var4);
	}
	...
	public double getDistance(double var1, double var3, double var5) {
		...
		double var9 = this.posY - var3;
		double var11 = this.posZ - var5;
		return (double) net.minecraft.util.MathHelper.sqrt_double(var7 * var7 + var9 * var9 + var11 * var11);
	}
	...
	public void onCollideWithPlayer(net.minecraft.entity.living.EntityPlayer var1) {
	}
	...
	public void applyEntityCollision(Entity var1) {
		if(var1.riddenByEntity != this && var1.ridingEntity != this) {
			...
			double var6 = net.minecraft.util.MathHelper.abs_max(var2, var4);
			if(var6 >= (double)0.01F) {
				var6 = (double) net.minecraft.util.MathHelper.sqrt_double(var6);
				var2 /= var6;
				var4 /= var6;
	...
	public boolean isEntityInsideOpaqueBlock() {
		for(int var1 = 0; var1 < 8; ++var1) {
			...
			int var5 = net.minecraft.util.MathHelper.floor_double(this.posX + (double)var2);
			int var6 = net.minecraft.util.MathHelper.floor_double(this.posY + (double)this.getEyeHeight() + (double)var3);
			int var7 = net.minecraft.util.MathHelper.floor_double(this.posZ + (double)var4);
	...
	protected boolean func_28005_g(double var1, double var3, double var5) {
		int var7 = net.minecraft.util.MathHelper.floor_double(var1);
		int var8 = net.minecraft.util.MathHelper.floor_double(var3);
