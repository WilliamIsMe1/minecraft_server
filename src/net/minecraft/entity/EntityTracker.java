...
public class EntityTracker {
	...
	public void trackEntity(net.minecraft.entity.Entity var1) {
		...
		} else if(var1 instanceof ILiving) {
	...
	public void trackEntity(net.minecraft.entity.Entity var1, int var2, int var3) {
		this.trackEntity(var1, var2, var3, false);
	}

	public void trackEntity(net.minecraft.entity.Entity var1, int var2, int var3, boolean var4) {
	...
	public void untrackEntity(net.minecraft.entity.Entity var1) {
		if(var1 instanceof EntityPlayerMP) {
			EntityPlayerMP var2 = (EntityPlayerMP)var1;
			Iterator var3 = this.trackedEntitySet.iterator();
	...
	public void sendPacketToTrackedPlayers(net.minecraft.entity.Entity var1, Packet var2) {
