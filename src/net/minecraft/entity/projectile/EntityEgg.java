...
public class EntityEgg extends net.minecraft.entity.Entity {
	...
	public int shake = 0;
	private net.minecraft.entity.living.EntityLiving field_20083_aj;
	...
	public EntityEgg(net.minecraft.world.World var1, EntityLiving var2) {
		...
		this.yOffset = 0.0F;
		float var3 = 0.4F;
		this.motionX = (double)(-net.minecraft.util.MathHelper.sin(this.rotationYaw / 180.0F * (float)Math.PI) * net.minecraft.util.MathHelper.cos(this.rotationPitch / 180.0F * (float)Math.PI) * var3);
		this.motionZ = (double)(net.minecraft.util.MathHelper.cos(this.rotationYaw / 180.0F * (float)Math.PI) * net.minecraft.util.MathHelper.cos(this.rotationPitch / 180.0F * (float)Math.PI) * var3);
		this.motionY = (double)(-net.minecraft.util.MathHelper.sin(this.rotationPitch / 180.0F * (float)Math.PI) * var3);
		...
		if(var3 != null) {
			...
			if(this.worldObj.multiplayerWorld && this.rand.nextInt(8) == 0) {
				...
				for(int var17 = 0; var17 < var16; ++var17) {
					net.minecraft.entity.living.creature.animal.EntityChicken var21 = new EntityChicken(this.worldObj);
