...
public class EntityArrow extends net.minecraft.entity.Entity {
	...
	public net.minecraft.entity.living.EntityLiving owner;
	...
	public EntityArrow(World var1, EntityLiving var2) {
		super(var1);
		this.owner = var2;
		this.field_28012_a = var2 instanceof net.minecraft.entity.living.EntityPlayer;
		this.setSize(0.5F, 0.5F);
		this.setLocationAndAngles(var2.posX, var2.posY + (double)var2.getEyeHeight(), var2.posZ, var2.rotationYaw, var2.rotationPitch);
		this.posX -= (double)(net.minecraft.util.MathHelper.cos(this.rotationYaw / 180.0F * (float)Math.PI) * 0.16F);
		this.posY -= (double)0.1F;
		this.posZ -= (double)(net.minecraft.util.MathHelper.sin(this.rotationYaw / 180.0F * (float)Math.PI) * 0.16F);
		this.setPosition(this.posX, this.posY, this.posZ);
		this.yOffset = 0.0F;
		this.motionX = (double)(-net.minecraft.util.MathHelper.sin(this.rotationYaw / 180.0F * (float)Math.PI) * net.minecraft.util.MathHelper.cos(this.rotationPitch / 180.0F * (float)Math.PI));
		this.motionZ = (double)(net.minecraft.util.MathHelper.cos(this.rotationYaw / 180.0F * (float)Math.PI) * net.minecraft.util.MathHelper.cos(this.rotationPitch / 180.0F * (float)Math.PI));
		this.motionY = (double)(-net.minecraft.util.MathHelper.sin(this.rotationPitch / 180.0F * (float)Math.PI));
	...
	public void setArrowHeading(double var1, double var3, double var5, float var7, float var8) {
		float var9 = net.minecraft.util.MathHelper.sqrt_double(var1 * var1 + var3 * var3 + var5 * var5);
		var1 /= (double)var9;
		var3 /= (double)var9;
		var5 /= (double)var9;
		...
		this.motionY = var3;
		this.motionZ = var5;
		float var10 = net.minecraft.util.MathHelper.sqrt_double(var1 * var1 + var5 * var5);
		...
		if(this.inGround) {
			...
			if(var3 != null) {
				if(var3.entityHit != null) {
					...
					var19 = net.minecraft.util.MathHelper.sqrt_double(this.motionX * this.motionX + this.motionY * this.motionY + this.motionZ * this.motionZ);
