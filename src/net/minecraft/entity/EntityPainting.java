...
public class EntityPainting extends net.minecraft.entity.Entity {
	...
	public EntityPainting(net.minecraft.world.World var1) {
		super(var1);
		this.field_452_ad = 0;
		this.direction = 0;
		this.yOffset = 0.0F;
	...
	public boolean onValidSurface() {
		if(this.worldObj.getCollidingBoundingBoxes(this, this.boundingBox).size() > 0) {
			...
			if(this.direction == 0) {
				var3 = net.minecraft.util.MathHelper.floor_double(this.posX - (double)((float)this.art.sizeX / 32.0F));
			}

			if(this.direction == 1) {
				var5 = net.minecraft.util.MathHelper.floor_double(this.posZ - (double)((float)this.art.sizeX / 32.0F));
			}
