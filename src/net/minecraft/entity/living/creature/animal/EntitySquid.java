...
public class EntitySquid extends EntityWaterMob {
	...
	public void onLivingUpdate() {
		...
		if(this.isInWater()) {
			...
			if(this.field_21060_ak < (float)Math.PI) {
				...
				this.field_21057_am = net.minecraft.util.MathHelper.sin(var1 * var1 * (float)Math.PI) * (float)Math.PI * 0.25F;
			...
			var1 = net.minecraft.util.MathHelper.sqrt_double(this.motionX * this.motionX + this.motionZ * this.motionZ);
			...
			this.field_21057_am = net.minecraft.util.MathHelper.abs(net.minecraft.util.MathHelper.sin(this.field_21060_ak)) * (float)Math.PI * 0.25F;
			if(!this.isMultiplayerEntity) {
				this.motionX = 0.0D;
				this.motionY -= 0.08D;
	...
	protected void updatePlayerActionState() {
		if(this.rand.nextInt(50) == 0 || !this.inWater || this.field_21052_ar == 0.0F && this.field_21051_as == 0.0F && this.field_21050_at == 0.0F) {
			...
			this.field_21052_ar = net.minecraft.util.MathHelper.cos(var1) * 0.2F;
