...
public class EntityWolf extends EntityAnimal {
	...
	protected void updatePlayerActionState() {
		...
		if(!this.hasAttacked && !this.getGotPath() && this.func_25030_y() && this.ridingEntity == null) {
			net.minecraft.entity.living.EntityPlayer var3 = this.worldObj.getPlayerEntityByName(this.getOwner());
			if(var3 != null) {
	...
	public void onLivingUpdate() {
		...
		if(this.func_25021_O() && !this.getGotPath() && !this.getIsAngry()) {
			...
			if(var1 instanceof net.minecraft.entity.living.EntityPlayer) {
				net.minecraft.entity.living.EntityPlayer var2 = (net.minecraft.entity.living.EntityPlayer)var1;
				ItemStack var3 = var2.inventory.getCurrentItem();
				if(var3 != null) {
					if(!this.func_25030_y() && var3.itemID == net.minecraft.item.core.Item.bone.shiftedIndex) {
						this.field_25039_a = true;
					} else if(this.func_25030_y() && net.minecraft.item.core.Item.itemsList[var3.itemID] instanceof ItemFood) {
						this.field_25039_a = ((ItemFood) net.minecraft.item.core.Item.itemsList[var3.itemID]).func_25010_k();
					}
				}
			}
		}
	...
	public void onUpdate() {
		...
		if(this.func_27008_Y()) {
			...
			if(this.field_25041_h > 0.4F) {
				...
				int var2 = (int)(net.minecraft.util.MathHelper.sin((this.field_25041_h - 0.4F) * (float)Math.PI) * 7.0F);
	...
	private void setPathEntity(net.minecraft.entity.Entity var1, float var2) {
		net.minecraft.entity.pathfinding.PathEntity var3 = this.worldObj.getPathToEntity(this, var1, 16.0F);
		if(var3 == null && var2 > 12.0F) {
			int var4 = net.minecraft.util.MathHelper.floor_double(var1.posX) - 2;
			int var5 = net.minecraft.util.MathHelper.floor_double(var1.posZ) - 2;
			int var6 = net.minecraft.util.MathHelper.floor_double(var1.boundingBox.minY);
	...
	public boolean attackEntityFrom(net.minecraft.entity.Entity var1, int var2) {
		this.setIsSitting(false);
		if(var1 != null && !(var1 instanceof net.minecraft.entity.living.EntityPlayer) && !(var1 instanceof net.minecraft.entity.projectile.EntityArrow)) {
			var2 = (var2 + 1) / 2;
		}
		...
		if(!super.attackEntityFrom((net.minecraft.entity.Entity)var1, var2)) {
			...
			if(!this.func_25030_y() && !this.getIsAngry()) {
				...
				if(var1 instanceof net.minecraft.entity.projectile.EntityArrow && ((net.minecraft.entity.projectile.EntityArrow)var1).owner != null) {
				...
				if(this.func_25030_y() && var1 instanceof net.minecraft.entity.living.EntityPlayer && ((net.minecraft.entity.living.EntityPlayer)var1).username.equalsIgnoreCase(this.getOwner())) {
					return true;
				}
	...
	public boolean interact(EntityPlayer var1) {
		...
		if(!this.func_25030_y()) {
			if(var2 != null && var2.itemID == net.minecraft.item.core.Item.bone.shiftedIndex && !this.getIsAngry()) {
				--var2.stackSize;
				if(var2.stackSize <= 0) {
			...
			if(var2 != null && net.minecraft.item.core.Item.itemsList[var2.itemID] instanceof ItemFood) {
				ItemFood var3 = (ItemFood) net.minecraft.item.core.Item.itemsList[var2.itemID];
