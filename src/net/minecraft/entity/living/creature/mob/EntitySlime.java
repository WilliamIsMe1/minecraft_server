...
public class EntitySlime extends EntityLiving implements IMob {
	...
	public void onUpdate() {
		...
		if(this.onGround && !var1) {
			...
			for(int var3 = 0; var3 < var2 * 8; ++var3) {
				...
				float var6 = net.minecraft.util.MathHelper.sin(var4) * (float)var2 * 0.5F * var5;
				float var7 = net.minecraft.util.MathHelper.cos(var4) * (float)var2 * 0.5F * var5;
	...
	protected void updatePlayerActionState() {
		this.func_27013_Q();
		net.minecraft.entity.living.EntityPlayer var1 = this.worldObj.getClosestPlayerToEntity(this, 16.0D);
		if(var1 != null) {
	...
	public boolean getCanSpawnHere() {
		Chunk var1 = this.worldObj.getChunkFromBlockCoords(net.minecraft.util.MathHelper.floor_double(this.posX), MathHelper.floor_double(this.posZ));
