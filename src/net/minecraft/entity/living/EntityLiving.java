...
public abstract class EntityLiving extends net.minecraft.entity.Entity {
	...
	private net.minecraft.entity.Entity currentTarget;
	...
	public boolean canEntityBeSeen(net.minecraft.entity.Entity var1) {
	...
	public void onEntityUpdate() {
		...
		if(this.isEntityAlive() && this.isInsideOfMaterial(Material.water) && !this.canBreatheUnderwater()) {
			...
			if(this.air == -20) {
				...
				this.attackEntityFrom((net.minecraft.entity.Entity)null, 2);
			}
	...
	public void onUpdate() {
		...
		float var5 = net.minecraft.util.MathHelper.sqrt_double(var1 * var1 + var3 * var3);
	...
	public void knockBack(net.minecraft.entity.Entity var1, int var2, double var3, double var5) {
		float var7 = net.minecraft.util.MathHelper.sqrt_double(var3 * var3 + var5 * var5);
		float var8 = 0.4F;
		this.motionX /= 2.0D;
		this.motionY /= 2.0D;
		this.motionZ /= 2.0D;
	...
	protected void fall(float var1) {
		...
		if(var2 > 0) {
			this.attackEntityFrom((net.minecraft.entity.Entity)null, var2);
			int var3 = this.worldObj.getBlockId(net.minecraft.util.MathHelper.floor_double(this.posX), net.minecraft.util.MathHelper.floor_double(this.posY - (double)0.2F - (double)this.yOffset), net.minecraft.util.MathHelper.floor_double(this.posZ));
			if(var3 > 0) {
	...
	public void moveEntityWithHeading(float var1, float var2) {
		...
		if(this.isInWater()) {
			...
			if(this.onGround) {
				...
				int var4 = this.worldObj.getBlockId(net.minecraft.util.MathHelper.floor_double(this.posX), net.minecraft.util.MathHelper.floor_double(this.boundingBox.minY) - 1, net.minecraft.util.MathHelper.floor_double(this.posZ));
				if(var4 > 0) {
			...
			if(this.onGround) {
				var8 = 546.0F * 0.1F * 0.1F * 0.1F;
				int var5 = this.worldObj.getBlockId(net.minecraft.util.MathHelper.floor_double(this.posX), net.minecraft.util.MathHelper.floor_double(this.boundingBox.minY) - 1, net.minecraft.util.MathHelper.floor_double(this.posZ));
				if(var5 > 0) {
		...
		float var7 = net.minecraft.util.MathHelper.sqrt_double(var3 * var3 + var11 * var11) * 4.0F;
		if(var7 > 1.0F) {
			var7 = 1.0F;
		}
	...
	public boolean isOnLadder() {
		int var1 = net.minecraft.util.MathHelper.floor_double(this.posX);
		int var2 = net.minecraft.util.MathHelper.floor_double(this.boundingBox.minY);
		int var3 = net.minecraft.util.MathHelper.floor_double(this.posZ);
	...
	public void onLivingUpdate() {
		...
		if(var15 != null && var15.size() > 0) {
			for(int var4 = 0; var4 < var15.size(); ++var4) {
				net.minecraft.entity.Entity var16 = (net.minecraft.entity.Entity)var15.get(var4);
	...
	public void faceEntity(net.minecraft.entity.Entity var1, float var2, float var3) {
		double var4 = var1.posX - this.posX;
		...
		double var14 = (double) net.minecraft.util.MathHelper.sqrt_double(var4 * var4 + var8 * var8);
	...
	public net.minecraft.entity.Entity getCurrentTarget() {
	...
	public net.minecraft.core.Vec3D getLook(float var1) {
		...
		float var5;
		if(var1 == 1.0F) {
			var2 = net.minecraft.util.MathHelper.cos(-this.rotationYaw * ((float)Math.PI / 180.0F) - (float)Math.PI);
			var3 = net.minecraft.util.MathHelper.sin(-this.rotationYaw * ((float)Math.PI / 180.0F) - (float)Math.PI);
			var4 = -net.minecraft.util.MathHelper.cos(-this.rotationPitch * ((float)Math.PI / 180.0F));
			var5 = net.minecraft.util.MathHelper.sin(-this.rotationPitch * ((float)Math.PI / 180.0F));
			...
			var4 = net.minecraft.util.MathHelper.cos(-var3 * ((float)Math.PI / 180.0F) - (float)Math.PI);
			var5 = net.minecraft.util.MathHelper.sin(-var3 * ((float)Math.PI / 180.0F) - (float)Math.PI);
			float var6 = -net.minecraft.util.MathHelper.cos(-var2 * ((float)Math.PI / 180.0F));
