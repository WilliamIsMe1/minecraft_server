...
public class EntityBoat extends net.minecraft.entity.Entity {
	...
	public EntityBoat(net.minecraft.world.World var1) {
		super(var1);
		this.damageTaken = 0;
		this.field_9177_b = 0;
		...
		if(!this.worldObj.singleplayerWorld && !this.isDead) {
			...
			if(this.damageTaken > 40) {
				...
				for(var3 = 0; var3 < 2; ++var3) {
					this.dropItemWithOffset(net.minecraft.item.core.Item.stick.shiftedIndex, 1, 0.0F);
				}
	...
	public void onUpdate() {
		...
		if(this.worldObj.singleplayerWorld) {
			...
			for(var24 = 0; var24 < 4; ++var24) {
				int var25 = net.minecraft.util.MathHelper.floor_double(this.posX + ((double)(var24 % 2) - 0.5D) * 0.8D);
				int var26 = net.minecraft.util.MathHelper.floor_double(this.posY);
