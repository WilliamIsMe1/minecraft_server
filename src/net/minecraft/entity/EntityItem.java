...
public class EntityItem extends net.minecraft.entity.Entity {
	...
	public void onUpdate() {
		...
		if(this.worldObj.getBlockMaterial(MathHelper.floor_double(this.posX), MathHelper.floor_double(this.posY), MathHelper.floor_double(this.posZ)) == net.minecraft.block.material.Material.lava) {
			this.motionY = (double)0.2F;
