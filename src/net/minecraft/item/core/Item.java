...
import net.minecraft.item.gear.EnumToolMaterial;
import net.minecraft.item.gear.ItemBucket;
import net.minecraft.item.gear.ItemMap;
import net.minecraft.item.gear.ItemPickaxe;
import net.minecraft.item.gear.ItemSaddle;
import net.minecraft.item.gear.ItemShears;
import net.minecraft.item.gear.ItemSword;
import net.minecraft.item.food.ItemCookie;
import net.minecraft.item.food.ItemEgg;
...
import net.minecraft.item.gear.ItemAxe;
import net.minecraft.item.gear.ItemBow;
import net.minecraft.item.gear.ItemFishingRod;
import net.minecraft.item.gear.ItemFlintAndSteel;
import net.minecraft.item.gear.ItemHoe;
import net.minecraft.item.gear.ItemSpade;
...
public class Item {
	...
	public static Item shovelSteel = (new ItemSpade(0, net.minecraft.item.gear.EnumToolMaterial.IRON)).setIconCoord(2, 5).setItemName("shovelIron");
	public static Item pickaxeSteel = (new ItemPickaxe(1, net.minecraft.item.gear.EnumToolMaterial.IRON)).setIconCoord(2, 6).setItemName("pickaxeIron");
	public static Item axeSteel = (new ItemAxe(2, net.minecraft.item.gear.EnumToolMaterial.IRON)).setIconCoord(2, 7).setItemName("hatchetIron");
	...
	public static Item coal = (new net.minecraft.item.ItemCoal(7)).setIconCoord(7, 0).setItemName("coal");
	...
	public static Item swordSteel = (new ItemSword(11, net.minecraft.item.gear.EnumToolMaterial.IRON)).setIconCoord(2, 4).setItemName("swordIron");
	public static Item swordWood = (new ItemSword(12, net.minecraft.item.gear.EnumToolMaterial.WOOD)).setIconCoord(0, 4).setItemName("swordWood");
	public static Item shovelWood = (new ItemSpade(13, net.minecraft.item.gear.EnumToolMaterial.WOOD)).setIconCoord(0, 5).setItemName("shovelWood");
	public static Item pickaxeWood = (new ItemPickaxe(14, net.minecraft.item.gear.EnumToolMaterial.WOOD)).setIconCoord(0, 6).setItemName("pickaxeWood");
	public static Item axeWood = (new ItemAxe(15, net.minecraft.item.gear.EnumToolMaterial.WOOD)).setIconCoord(0, 7).setItemName("hatchetWood");
	public static Item swordStone = (new ItemSword(16, net.minecraft.item.gear.EnumToolMaterial.STONE)).setIconCoord(1, 4).setItemName("swordStone");
	public static Item shovelStone = (new ItemSpade(17, net.minecraft.item.gear.EnumToolMaterial.STONE)).setIconCoord(1, 5).setItemName("shovelStone");
	public static Item pickaxeStone = (new ItemPickaxe(18, net.minecraft.item.gear.EnumToolMaterial.STONE)).setIconCoord(1, 6).setItemName("pickaxeStone");
	public static Item axeStone = (new ItemAxe(19, net.minecraft.item.gear.EnumToolMaterial.STONE)).setIconCoord(1, 7).setItemName("hatchetStone");
	public static Item swordDiamond = (new ItemSword(20, net.minecraft.item.gear.EnumToolMaterial.DIAMOND)).setIconCoord(3, 4).setItemName("swordDiamond");
	public static Item shovelDiamond = (new ItemSpade(21, net.minecraft.item.gear.EnumToolMaterial.DIAMOND)).setIconCoord(3, 5).setItemName("shovelDiamond");
	public static Item pickaxeDiamond = (new ItemPickaxe(22, net.minecraft.item.gear.EnumToolMaterial.DIAMOND)).setIconCoord(3, 6).setItemName("pickaxeDiamond");
	public static Item axeDiamond = (new ItemAxe(23, net.minecraft.item.gear.EnumToolMaterial.DIAMOND)).setIconCoord(3, 7).setItemName("hatchetDiamond");
	...
	public static Item swordGold = (new ItemSword(27, net.minecraft.item.gear.EnumToolMaterial.GOLD)).setIconCoord(4, 4).setItemName("swordGold");
	public static Item shovelGold = (new ItemSpade(28, net.minecraft.item.gear.EnumToolMaterial.GOLD)).setIconCoord(4, 5).setItemName("shovelGold");
	public static Item pickaxeGold = (new ItemPickaxe(29, net.minecraft.item.gear.EnumToolMaterial.GOLD)).setIconCoord(4, 6).setItemName("pickaxeGold");
	public static Item axeGold = (new ItemAxe(30, net.minecraft.item.gear.EnumToolMaterial.GOLD)).setIconCoord(4, 7).setItemName("hatchetGold");
	...
	public static Item hoeWood = (new ItemHoe(34, net.minecraft.item.gear.EnumToolMaterial.WOOD)).setIconCoord(0, 8).setItemName("hoeWood");
	public static Item hoeStone = (new ItemHoe(35, net.minecraft.item.gear.EnumToolMaterial.STONE)).setIconCoord(1, 8).setItemName("hoeStone");
	public static Item hoeSteel = (new ItemHoe(36, net.minecraft.item.gear.EnumToolMaterial.IRON)).setIconCoord(2, 8).setItemName("hoeIron");
	public static Item hoeDiamond = (new ItemHoe(37, net.minecraft.item.gear.EnumToolMaterial.DIAMOND)).setIconCoord(3, 8).setItemName("hoeDiamond");
	...
	public static Item painting = (new net.minecraft.item.ItemPainting(65)).setIconCoord(10, 1).setItemName("painting");
	public static Item appleGold = (new ItemFood(66, 42, false)).setIconCoord(11, 0).setItemName("appleGold");
	public static Item sign = (new net.minecraft.item.ItemSign(67)).setIconCoord(10, 2).setItemName("sign");
	public static Item doorWood = (new net.minecraft.item.ItemDoor(68, net.minecraft.block.material.Material.wood)).setIconCoord(11, 2).setItemName("doorWood");
	...
	public static Item doorSteel = (new net.minecraft.item.ItemDoor(74, Material.iron)).setIconCoord(12, 2).setItemName("doorIron");
	public static Item redstone = (new ItemRedstone(75)).setIconCoord(8, 3).setItemName("redstone");
	public static Item snowball = (new net.minecraft.item.ItemSnowball(76)).setIconCoord(14, 0).setItemName("snowball");
	public static Item boat = (new net.minecraft.item.ItemBoat(77)).setIconCoord(8, 8).setItemName("boat");
	...
	public static Item reed = (new net.minecraft.item.ItemReed(82, Block.reed)).setIconCoord(11, 1).setItemName("reeds");
	...
	public static Item dyePowder = (new net.minecraft.item.ItemDye(95)).setIconCoord(14, 4).setItemName("dyePowder");
	...
	public static Item cake = (new net.minecraft.item.ItemReed(98, Block.cake)).setMaxStackSize(1).setIconCoord(13, 1).setItemName("cake");
	public static Item bed = (new ItemBed(99)).setMaxStackSize(1).setIconCoord(13, 2).setItemName("bed");
	public static Item redstoneRepeater = (new net.minecraft.item.ItemReed(100, Block.redstoneRepeaterIdle)).setIconCoord(6, 5).setItemName("diode");
	...
	public boolean onItemUse(ItemStack var1, net.minecraft.entity.living.EntityPlayer var2, net.minecraft.world.World var3, int var4, int var5, int var6, int var7) {
		return false;
	}
	...
	public ItemStack onItemRightClick(ItemStack var1, net.minecraft.world.World var2, net.minecraft.entity.living.EntityPlayer var3) {
		return var1;
	}
	...
	public boolean hitEntity(ItemStack var1, net.minecraft.entity.living.EntityLiving var2, net.minecraft.entity.living.EntityLiving var3) {
		return false;
	}

	public boolean func_25007_a(ItemStack var1, int var2, int var3, int var4, int var5, net.minecraft.entity.living.EntityLiving var6) {
		return false;
	}
	...
	public void func_28018_a(ItemStack var1, net.minecraft.world.World var2, Entity var3, int var4, boolean var5) {
	}
