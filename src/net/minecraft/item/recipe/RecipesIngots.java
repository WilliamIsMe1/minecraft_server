...
public class RecipesIngots {
	private Object[][] recipeItems = new Object[][]{{Block.blockGold, new ItemStack(net.minecraft.item.core.Item.ingotGold, 9)}, {Block.blockSteel, new ItemStack(net.minecraft.item.core.Item.ingotIron, 9)}, {Block.blockDiamond, new ItemStack(net.minecraft.item.core.Item.diamond, 9)}, {Block.blockLapis, new ItemStack(Item.dyePowder, 9, 4)}};
