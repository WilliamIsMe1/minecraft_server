...
public class ShapedRecipes implements IRecipe {
	...
	public boolean func_21134_a(net.minecraft.item.container.inventory.InventoryCrafting var1) {
	...
	private boolean func_21139_a(net.minecraft.item.container.inventory.InventoryCrafting var1, int var2, int var3, boolean var4) {
