...
public class InventoryLargeChest implements net.minecraft.item.container.inventory.IInventory {
	private String name;
	private net.minecraft.item.container.inventory.IInventory upperChest;
	private net.minecraft.item.container.inventory.IInventory lowerChest;

	public InventoryLargeChest(String var1, net.minecraft.item.container.inventory.IInventory var2, IInventory var3) {
		this.name = var1;
