...
public class SlotCrafting extends Slot {
	private final net.minecraft.item.container.inventory.IInventory craftMatrix;
	private net.minecraft.entity.living.EntityPlayer field_25004_e;

	public SlotCrafting(EntityPlayer var1, net.minecraft.item.container.inventory.IInventory var2, IInventory var3, int var4, int var5, int var6) {
