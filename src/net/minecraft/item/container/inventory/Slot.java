...
public class Slot {
	...
	private final net.minecraft.item.container.inventory.IInventory inventory;
	public int id;
	public int xDisplayPosition;
	public int yDisplayPosition;

	public Slot(net.minecraft.item.container.inventory.IInventory var1, int var2, int var3, int var4) {
		this.inventory = var1;
		this.slotIndex = var2;
