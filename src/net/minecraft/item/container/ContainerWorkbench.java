...
public class ContainerWorkbench extends Container {
	public net.minecraft.item.container.inventory.InventoryCrafting craftMatrix = new net.minecraft.item.container.inventory.InventoryCrafting(this, 3, 3);
	public net.minecraft.item.container.inventory.IInventory craftResult = new net.minecraft.item.container.inventory.InventoryCraftResult();
	private net.minecraft.world.World field_20150_c;
	...
	public ContainerWorkbench(InventoryPlayer var1, World var2, int var3, int var4, int var5) {
		...
		for(var6 = 0; var6 < 3; ++var6) {
			for(var7 = 0; var7 < 3; ++var7) {
				this.addSlot(new net.minecraft.item.container.inventory.Slot(this.craftMatrix, var7 + var6 * 3, 30 + var7 * 18, 17 + var6 * 18));
			}
		}

		for(var6 = 0; var6 < 3; ++var6) {
			for(var7 = 0; var7 < 9; ++var7) {
				this.addSlot(new net.minecraft.item.container.inventory.Slot(var1, var7 + var6 * 9 + 9, 8 + var7 * 18, 84 + var6 * 18));
			}
		}

		for(var6 = 0; var6 < 9; ++var6) {
			this.addSlot(new net.minecraft.item.container.inventory.Slot(var1, var6, 8 + var6 * 18, 142));
		}
