...
public abstract class Container {
	...
	public ItemStack func_27085_a(int var1, int var2, boolean var3, net.minecraft.entity.living.EntityPlayer var4) {
		ItemStack var5 = null;
		if(var2 == 0 || var2 == 1) {
	...
	public boolean getCanCraft(net.minecraft.entity.living.EntityPlayer var1) {
		return !this.field_20131_b.contains(var1);
	}

	public void setCanCraft(net.minecraft.entity.living.EntityPlayer var1, boolean var2) {
		if(var2) {
