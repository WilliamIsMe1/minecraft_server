...
public class ItemMap extends ItemMapBase {
	...
	public net.minecraft.map.MapData func_28023_a(net.minecraft.item.core.ItemStack var1, net.minecraft.world.World var2) {
		(new StringBuilder()).append("map_").append(var1.getItemDamage()).toString();
		net.minecraft.map.MapData var4 = (net.minecraft.map.MapData)var2.func_28103_a(net.minecraft.map.MapData.class, "map_" + var1.getItemDamage());
		if(var4 == null) {
	...
	public void func_28024_a(net.minecraft.world.World var1, net.minecraft.entity.Entity var2, net.minecraft.map.MapData var3) {
		if(var1.worldProvider.worldType == var3.field_28162_d) {
			...
			int var9 = net.minecraft.util.MathHelper.floor_double(var2.posX - (double)var7) / var6 + var4 / 2;
			int var10 = net.minecraft.util.MathHelper.floor_double(var2.posZ - (double)var8) / var6 + var5 / 2;
			int var11 = 128 / var6;
	...
	public void func_28020_c(net.minecraft.item.core.ItemStack var1, net.minecraft.world.World var2, net.minecraft.entity.living.EntityPlayer var3) {
		var1.setItemDamage(var2.func_28104_b("map"));
		String var4 = "map_" + var1.getItemDamage();
		net.minecraft.map.MapData var5 = new MapData(var4);
		var2.func_28102_a(var4, var5);
		var5.field_28164_b = net.minecraft.util.MathHelper.floor_double(var3.posX);
