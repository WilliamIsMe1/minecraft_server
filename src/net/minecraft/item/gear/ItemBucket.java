...
public class ItemBucket extends net.minecraft.item.core.Item {
	private int isFull;
	...
	public ItemStack onItemRightClick(ItemStack var1, World var2, EntityPlayer var3) {
		...
		if(var24 == null) {
			...
			if(var24.typeOfHit == EnumMovingObjectType.TILE) {
				...
				if(this.isFull == 0) {
					if(var2.getBlockMaterial(var25, var26, var27) == net.minecraft.block.material.Material.water && var2.getBlockMetadata(var25, var26, var27) == 0) {
						var2.setBlockWithNotify(var25, var26, var27, 0);
						return new ItemStack(net.minecraft.item.core.Item.bucketWater);
					}

					if(var2.getBlockMaterial(var25, var26, var27) == Material.lava && var2.getBlockMetadata(var25, var26, var27) == 0) {
						var2.setBlockWithNotify(var25, var26, var27, 0);
						return new ItemStack(net.minecraft.item.core.Item.bucketLava);
					}
				} else {
					if(this.isFull < 0) {
						return new ItemStack(net.minecraft.item.core.Item.bucketEmpty);
					}
